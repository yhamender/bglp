<?php
/*
 * Template Name: SupSub Category Product
*/
?>
...
<div class="refinement category-refinement category-level-2 fourth" style="display: none;">
  ...
  <div class="refinement category-refinement category-level-2 fifth" style="display: none;">
   ...
   <ul class="selected-refinement">
       <li class="">
          ...
          <a class="refinement-link non-ajax <?php if($sup_sub_category_id==$sc->term_id) { ?> active <?php } else { ?>not-selected <?php } ?>" title="<?php echo $sc->name; ?>" href="<?php echo site_url('filter-product/?'.$whatIWant.'&rhands=right');?>">Right</a>

        </li>

        <li class="">
          
          <a class="refinement-link non-ajax <?php if($sup_sub_category_id==$sc->term_id) { ?> active <?php } else { ?>not-selected <?php } ?>" title="<?php echo $sc->name; ?>" href="<?php echo site_url('filter-product/?'.$whatIWant.'&lhands=left');?>">Left</a>
  ...
  <div class="refinement category-refinement category-level-2 sixth" style="display: block;">
    <h3 class="expanded"><span> Hands </span> <span class="glyphicon glyphicon-menu-up sixthup" style="float: right; margin-top: -18px;"></span>
...
<?php } ?> -->
  ...
  <div class="refinement category-refinement category-level-2 seven" style="display: none;">
 ...
 foreach ($subcats as $sc) {
    ...
    ?>
        ...
        <li class="">
          ...
          <a class="refinement-link non-ajax <?php if($sup_sub_category_id==$sc->term_id) { ?> active <?php } else { ?>not-selected <?php } ?>" title="<?php echo $sc->name; ?>" href="<?php echo site_url('filter-product/?category='.$category_id.'&subcategory='.$subcategory_id.'&supsubcategory='.$sup_sub_category_id.'&loft'.$y.'='.$sc->term_id);?>">
...
<div class="refinement category-refinement category-level-2 eight" style="display: block;">
...
<?php if($category_id=='44') { ?> 
  ...
  <div class="refinement category-refinement category-level-2 nine" style="display: none;">
 ...
 foreach ($subcats as $sc) {
    ...
    ?>
        ...
        <li class="">
          ...
          <a class="refinement-link non-ajax <?php if($sup_sub_category_id==$sc->term_id) { ?> active <?php } else { ?>not-selected <?php } ?>" title="<?php echo $sc->name; ?>" href="<?php echo site_url('filter-product/?category='.$category_id.'&subcategory='.$subcategory_id.'&supsubcategory='.$sup_sub_category_id.'&flex'.$z.'='.$sc->term_id);?>">     <?php echo $sc->name; ?></a>
...
<div class="refinement category-refinement category-level-2 ten" style="display: block;">
...
<?php
        $args = array( 'post_type' => 'product',  'product_cat' => $name_sup_subcategory , 'posts_per_page' => '100', 'orderby' => 'rand' );
