<?php
/*
 * Template Name: vienna-airport-golfclub
 * 
 */
?>
...
color: #fff; min-height:270px; text-align: center; width:100%; background-size: cover;">
  <h1 style="margin-top: 147px; color: #fff!important; font-size: 47px; font-family: 'Fjalla One', sans-serif!important;">Vienna Airport Golfclub</h1>
</div>
<div class="container">
...
<div class="col-md-10 col-md-offset-1" style="padding: 0px 50px 0px 50px;font-size:17px; font:normal normal normal 16px/1.4em proxima-n-w01-reg,sans-serif; color:#414141; line-height:1.9em; text-align:justify;">
    <h3>
       Als Mitglied des <strong>„VIENNA AIRPORT GOLFCLUB“</strong> profitieren Sie von 40€ Nachlass auf Ihre <br/>
       <br/>
    ...
    <ul style="list-style-type:square;">
        ...
        <li>Nutzen Sie den Gutscheincode <strong><font color="#FFD700">VIE2020</font></strong> nach der Registrierung.</li>
