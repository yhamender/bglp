...
<!-- 'product_cat' => 'shoes' -->
   ...
   <div class="col-md-12">
    ...
    <div class="col-md-2" style="border: 2px solid; height: auto;" >
      ...
      <br/>
     <p style="font-size: 20px; font-family: fantasy;">Select Category</p>
      <select class="form-control" id='issue_no' name="cat" style="font-size: 14px; font-family: fantasy;">
...
<div class="first">
    ...
    <br/>
      ...
      <p style="font-family: fantasy; font-size: 17px;">Select Sub-Category    <span class="glyphicon glyphicon-menu-down"></span>  </p>
<?php
    echo '<ul class="wooc_sclist">';
      foreach ($subcats as $sc) {
        $category_id = $_GET['category'];
        $link = get_term_link( $sc->slug, $sc->taxonomy );
          echo '<li><a href="'.site_url('subcategory-product/?category='.$category_id.'&subcategory='.$sc->term_id).'" style="font-size:16px; font-family: fantasy;">'.$sc->name.'</a></li>';
      }
    echo '</ul>';
...
?>
 ...
 <?php } ?>
   ...
   <div class="second" style="display: none;">
      ...
      <p style="font-family: fantasy; font-size: 17px;">Select Sub-Category    <span class="glyphicon glyphicon-menu-up"></span>  </p>  
