<?php
/*
 * Template Name: User-Download-Card
*/
?>
<?php get_header(); ?>
...
<div class="container">
  <div class="row spacer">
    <div class="container" style="margin:50px 0px 40px;">
      ...
      <?php  $payment=get_user_meta( $user_id, '_cardtype', true ); ?>

    <?php   if($payment=='99')  { ?>


      <div style="background:url('<?php echo get_template_directory_uri();?>/assets/img/gold_card_user.png') no-repeat center; height:400px; ">
       
           

       <span style=" position: relative; top: 33px; left: 672px; font-size: 18px;  font-family: 'Fjalla One', sans-serif!important;"><?php echo $userData->user_login; ?></span>

       <span style="position: relative; top:271px; left:270px; font-size:62px;     font-family: 'Fjalla One', sans-serif!important;"><?php echo $userData->display_name; ?></span>
      ...
      <div style="background:url('<?php echo get_template_directory_uri();?>/assets/img/S.E.A.platinCARD_2019_druck.webp') no-repeat center; height:400px; ">
    ...
    <?php } ?>
      ...
      <a href="<?php echo site_url('download-card-2'); ?>" class="btn btn-default btn-lg">Download Your Card Now</a></div>
        </div>
      </div>
    </div>
  </div>
