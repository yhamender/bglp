...
color: #fff; min-height:270px; text-align: center; width:100%; background-size: cover;">
  <h1 style="margin-top: 147px; color: #fff!important; font-size: 47px; font-family: 'Fjalla One', sans-serif!important;">Golfclub</h1>
</div>
<div class="container">
...
<div class="col-md-10 col-md-offset-1" style="padding: 0px 50px 0px 50px;font-size:17px; font:normal normal normal 16px/1.4em proxima-n-w01-reg,sans-serif; color:#414141; line-height:1.9em; text-align:justify;">
    <h3> <b>Als S.E.A.Card Partnerclub profitieren Sie direkt von garantierten Mehreinnahmen, kostenloser Vermarktung und attraktiven Neukunden!
        Lukrative  Firmenspielrechte 
        Zusätzliche Greenfee Verkäufe 
        Erhöhter Gastronomie Umsatz 
        Zusatzverkäufe im Golfshop
       </b>
      <br/> <br/>
        <b>Langfristig entsteht Nutzen für den Golfclub! <br>
Bewerbung sowohl in Drucksorten als er auf der Web-Plattform wie in Form von Mundpropaganda.
</b>

    <b> Golfclubs welche die S.E.A.Card Mitgliedern aktiv anbieten erzählen nachweislich hohe jährlich wiederkehrende Einnahmen durch den Verkauf von S.E.A. Karten an ihre Mitglieder und ermöglichen diesen gleichzeitig die Nutzung anderer Partnerclubs ohne Zusatzkosten.
</b>
        <br> <b>Die S.E.A.Card stellt eine Serviceleistung dar, welche von Clubmitgliedern wertgeschätzt wird und gleichzeitig zu einer höheren Bindung an jene Golfclub führt, in denen die S.E.A.Card zu Mitgliederkonditionen angeboten wird. 
</b>
    <br/>
    <b>Interesse an einer Partnerschaft? Wenden Sie sich gerne an unser Team.</b>
    </h3>
    <h3> <b>E-Mail: jm@s-e-a.at <br/></b>
        <b> Tel.: 0732 771260 </b>
</h3>
</div>
