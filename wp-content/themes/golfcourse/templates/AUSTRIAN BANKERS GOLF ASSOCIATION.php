<?php
/*
 * Template Name: AUSTRIAN BANKERS GOLF ASSOCIATION
 */
?>
...
color: #fff; min-height:270px; text-align: center; width:100%; background-size: cover;">
  <h1 style="margin-top: 147px; color: #fff!important; font-size: 47px; font-family: 'Fjalla One', sans-serif!important;">AUSTRIAN BANKERS GOLF ASSOCIATION</h1>
</div>
<div class="container">
...
<div class="col-md-10 col-md-offset-1" style="padding: 0px 50px 0px 50px;font-size:17px; font:normal normal normal 16px/1.4em proxima-n-w01-reg,sans-serif; color:#414141; line-height:1.9em; text-align:justify;">
    <h3>
       Als Mitglied der <strong>„AUSTRIAN BANKERS GOLF ASSOCIATION“</strong> profitieren Sie von 40€ Nachlass auf Ihre <br/>
       <br/>
        S.E.A.PlatinCard für die Golfsaison 2020.
       
       <br/>
    
    <ul style="list-style-type:square;">
        <li>Bestellen Sie Ihre Karte auf <a href="https://golfcenter.at/ihre-s-e-a-card/">https://golfcenter.at/ihre-s-e-a-card/</a></li>
        <li>Nutzen Sie den Gutscheincode <strong><font color="#FFD700">„ABGA2020“</font></strong> nach der Registrierung.</li>
        <li>Sie erhalten Ihre S.E.A.PlatinCard um € 159,- statt € 199,-</li>
    </ul>
    ...
    <br/>Inkludiert sind:<br/>

                <ul style="list-style-type:square;">

                        <li>12 Kostenlose Golfrunden</li>
                        <li>30% und mehr Nachlass auf Markenprodukte von Taylor Made Golf</li>
                        <li>Attraktive Events & Reisen</li>
                        <li>Kostenlose Golftrainings</li>
                        <li>1 Vegas Golf 10-Chip</li>
                        <li>Game oder 1 PELT Original GRATIS</li>
                </ul>  
    </h3> <br/>
    <h3>
          Sie haben Fragen oder benötigen Unterstützung bei der Registrierung. Wenden Sie sich gerne an unser Team.
      
</h3> <br/>
    <h3> E-Mail: jm@s-e-a.at <br/>
         Tel.: 0732 771260
</h3>
</div>
