...
<div class="col-md-6" style="line-height: 30px; text-align: justify; margin-top: 50px; ">
     <p>Einmal eingeloggt <?php echo utf8_encode('können');?> Sie Ihr Profil komplettieren, sehen Ihre virtuelle S.E.A.CARD bzw. die verbleibenden S.E.A.Coins (Credits) auf Ihrer Karte sowie Ihre bislang <?php echo utf8_encode('getätigten');?> Buchungen und <?php echo utf8_encode('können');?> sofort Golfrunden reservieren. Weitere Features kommen in den <?php echo utf8_encode('nächsten');?> Wochen und Monaten hinzu.<br/><br/>For Update Password And UserName Click here :-<p>
