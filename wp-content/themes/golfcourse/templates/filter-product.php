...
<?php $sup_sub_category_id = $_GET['supsubcategory']; ?>

<?php if( $term = get_term_by( 'id', $sup_sub_category_id, 'product_cat' ) ){
    
    $name_sup_subcategory = $term->name;
    
    //echo $name_sup_subcategory;
...
<h2 class="visually-hidden">Refine Your Results By:</h2>
 ...
 foreach ($all_categories as $cat) {
   ...
   <div class="refinement category-refinement category-level-2 first">
    ...
    echo $term->name; 
} ?></span> <span class="glyphicon glyphicon-menu-down firstdown" style="float: right;     margin-top: -18px;"></span>
  ...
  $category_id = $_GET['category'];
    ...
    ?>
        ...
        <li class="">
          ...
          <a class="refinement-link non-ajax <?php if($subcategory_id==$sc->term_id) { ?> active <?php } else { ?>not-selected <?php } ?>" title="<?php echo $sc->name; ?>" href="<?php echo site_url('subcategory-product/?category='.$category_id.'&subcategory='.$sc->term_id);?>"><?php echo $sc->name; ?></a>

        </li>

        <?php if($subcategory_id==$sc->term_id) { ?>
          <a href="<?php echo site_url('category-product/?category='.$category_id);?>" style='float:right; color: #000; overflow: inherit;'> <span class='glyphicon glyphicon-remove' style=" margin-top: -34px;
    font-size: 18px;
    margin-right: 8px;
    color: #fff;"></span> </a>
        <?php   }  ?>
...
<div class="refinement category-refinement category-level-2 second" style="display: none;">
    <h3 class="expanded"><span><?php if( $term = get_term_by('id', $category_id, 'product_cat' ) ){
    echo $term->name;
} ?></span><span class="glyphicon glyphicon-menu-up secondup" style="float: right; margin-top: -17px;"></span> 
  ...
  <div class="refinement category-refinement category-level-2 third">
    <h3 class="expanded"><span><?php if( $term = get_term_by( 'id', $sub_category_id, 'product_cat' ) ){
    echo $term->name; 
} ?></span> <span class="glyphicon glyphicon-menu-down thirddown" style="float: right;  margin-top: -18px;"></span>
 ...
 foreach ($subcats as $sc) {
         $category_id = $_GET['category'];
         $subcategory_id = $_GET['subcategory'];
         $sup_sub_category_id = $_GET['supsubcategory'];
        $link = get_term_link( $sc->slug, $sc->taxonomy );

    ?>

         <?php if($sc->term_id=='124' || $sc->term_id=='114' || $sc->term_id=='134' || $sc->term_id=='130' || $sc->term_id=='187' || $sc->term_id=='179' || $sc->term_id=='140' || $sc->term_id=='167' || $sc->term_id=='209' || $sc->term_id=='193' || $sc->term_id=='217') {?>
       ...
       <?php } else { ?>
        ...
        <li class="">
          ...
          <a class="refinement-link non-ajax <?php if($sup_sub_category_id==$sc->term_id) { ?> active <?php } else { ?>not-selected <?php } ?>" title="<?php echo $sc->name; ?>" href="<?php echo site_url('supsubcategory-product/?category='.$category_id.'&subcategory='.$subcategory_id.'&supsubcategory='.$sc->term_id);?>"><?php echo $sc->name; ?></a>
...
<?php } ?>
        ...
        <?php if($sup_sub_category_id==$sc->term_id) { ?>
          <a href="<?php echo site_url('subcategory-product/?category='.$category_id.'&subcategory='.$subcategory_id);?>" style='float:right; color: #000; overflow: inherit;'> <span class='glyphicon glyphicon-remove' style=" margin-top: -34px;
    font-size: 18px;
    margin-right: 8px;
    color: #fff;"></span> </a>
        <?php   }  ?>
...
<div class="refinement category-refinement category-level-2 fourth" style="display: none;">
    <h3 class="expanded"><span><?php if( $term = get_term_by( 'id', $sub_category_id, 'product_cat' ) ){
    echo $term->name; 
} ?></span> <span class="glyphicon glyphicon-menu-up fourthup" style="float: right; margin-top: -18px;"></span>
      
    </h3>
  </div>


              <!-- End Sup Sub Category  -->
              ...
              <!-- <?php if($category_id=='44') { ?> 

  <div class="refinement category-refinement category-level-2 fifth">
    <h3 class="expanded"><span> Hands </span> <span class="glyphicon glyphicon-menu-down fifthdown" style="float: right; margin-top: -18px;"></span>
   ...
   <ul class="selected-refinement">
       <li class="">
          ...
          <a class="refinement-link non-ajax <?php if (isset($_GET['rhands'])) { ?> active  <?php } else { ?>not-selected <?php } ?>"  title="<?php echo $sc->name; ?>" <?php if (isset($_GET['rhands'])) { ?> href="" <?php } else { ?> href="<?php echo site_url('filter-product/?'.$whatIWant.'&rhands=right');?>" <?php } ?>>Right</a>

        </li>
         
        <?php if (isset($_GET['rhands'])) { ?>

          <?php  $actual_link2 = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]"; ?>
         
        <?php $actual_link2_final = str_replace("&rhands=right","",$actual_link2); ?>

        <a href="<?php echo $actual_link2_final; ?>" style='float:right; color: #000; overflow: inherit;'> <span class='glyphicon glyphicon-remove' style=" margin-top: -34px;
         font-size: 18px;
         margin-right: 8px;
         color: #fff;"></span> </a>
        <?php   }  ?>
        ...
        <li class="">
          ...
          <a class="refinement-link non-ajax <?php if (isset($_GET['lhands'])) { ?> active <?php } else { ?>not-selected <?php } ?>" title="<?php echo $sc->name; ?>" <?php if (isset($_GET['lhands'])) { ?> href="" <?php } else { ?> href="<?php echo site_url('filter-product/?'.$whatIWant.'&lhands=left');?>" <?php } ?>>Left</a>

        </li>

        <?php if (isset($_GET['lhands'])) { ?>

          <?php  $actual_link1 = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]"; ?>
         
        <?php $actual_link1_final =  str_replace("&lhands=left","",$actual_link1); ?>

        <a href="<?php echo $actual_link1_final;?>" style='float:right; color: #000; overflow: inherit;'> <span class='glyphicon glyphicon-remove' style=" margin-top: -34px;
         font-size: 18px;
         margin-right: 8px;
         color: #fff;"></span> </a>
        <?php   }  ?>
  ...
  <div class="refinement category-refinement category-level-2 sixth" style="display: none;">
    <h3 class="expanded"><span> Hands </span> <span class="glyphicon glyphicon-menu-down sixthup" style="float: right; margin-top: -18px;"></span>
...
<?php } ?> -->
  ...
  <div class="refinement category-refinement category-level-2 seven" style="display: block;">
    <h3 class="expanded"><span> Loft </span> <span class="glyphicon glyphicon-menu-down sevendown" style="float: right;  margin-top: -18px;"></span>
      
    </h3>

   <?php if($sub_category_id=='45') { 
       $loft_filter = '114';
    }
    ?>
    ...
    <?php if($sub_category_id=='46') { 
       $loft_filter = '130';
    }
    ?>

    <?php if($sub_category_id=='48') { 
       $loft_filter = '179';
    }
    ?>


     <?php if($sub_category_id=='47') { 
       $loft_filter = '167';
    }
    ?>


    <?php if($sub_category_id=='49') { 
       $loft_filter = '193';
    }
    ?>
    ...
    <ul class="selected-refinement">
       ...
       'show_option_none' => '',
       'hide_empty' => 0,
       'parent' => $loft_filter,  // Driver Loft 
       'taxonomy' => 'product_cat'
    );
  $subcats = get_categories($args);?>
 ...
 foreach ($subcats as $sc) {
    ...
    ?>
        ...
        <li class="">
          ...
          <?php  $actual_link5 = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]"; 
       
            $whatIWant5 = substr($actual_link5, strpos($actual_link5, "?") + 1);    ?>
          
          <a class="refinement-link non-ajax <?php if (isset($_GET['loft'.$y])) {  ?> active <?php } else { ?>not-selected <?php } ?>" title="<?php echo $sc->name; ?>" <?php if (isset($_GET['loft'.$y])) { ?> href="" <?php } else { ?> href="<?php echo site_url('filter-product/?'.$whatIWant5.'&loft'.$y.'='.$sc->term_id);?>" <?php } ?>>
        ...
        <?php if (isset($_GET['loft'.$y])) {  ?>
         
         <?php  $actual_link2 = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]"; ?>
         
        <?php $actual_link2_final = str_replace("&loft".$y.'='.$sc->term_id,"",$actual_link2); ?>
...
<div class="refinement category-refinement category-level-2 eight" style="display: none;">
    <h3 class="expanded"><span>Loft</span> <span class="glyphicon glyphicon-menu-up eightup" style="float: right; margin-top: -18px;"></span>
...
<?php } ?>
  ...
  <div class="refinement category-refinement category-level-2 nine" style="display: block;">
    <h3 class="expanded"><span> Flex </span> <span class="glyphicon glyphicon-menu-down ninedown" style="float: right;  margin-top: -18px;"></span>
      
    </h3>

    <?php if($sub_category_id=='45') { 
       $flex_filter = '124';  // Driver Flex 
    }
    ?>
    ...
    <ul class="selected-refinement">
       ...
       'show_option_none' => '',
       'hide_empty' => 0,
       'parent' => $flex_filter,  // Driver Flex 
       'taxonomy' => 'product_cat'
    );
  $subcats = get_categories($args);?>
    ...
    ?>
        ...
        <li class="">
          ...
          <?php  $actual_link1 = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]"; 
            ...
            $whatIWant1 = substr($actual_link1, strpos($actual_link1, "?") + 1);    ?>
          
          <a class="refinement-link non-ajax <?php if (isset($_GET['flex'.$z])) { ?> active <?php } else { ?>not-selected <?php } ?>" title="<?php echo $sc->name; ?>" <?php if (isset($_GET['flex'.$z])) { ?> href="" <?php } else { ?> href="<?php echo site_url('filter-product/?'.$whatIWant1.'&flex'.$z.'='.$sc->term_id);?>" <?php } ?>>    
           <?php echo $sc->name; ?>
        ...
        <?php if (isset($_GET['flex'.$z])) {  ?>


           <?php  $actual_link3 = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]"; ?>
         
        <?php $actual_link3_final = str_replace("&flex".$z.'='.$sc->term_id,"",$actual_link3); ?>
          <a href="<?php echo $actual_link3_final;?>" style='float:right; color: #000; overflow: inherit;'> <span class='glyphicon glyphicon-remove' style=" margin-top: -34px;
    font-size: 18px;
    margin-right: 8px;
    color: #fff;"></span> </a>
        <?php   }  ?>
...
<div class="refinement category-refinement category-level-2 ten" style="display: none;">
    <h3 class="expanded"><span>Flex</span> <span class="glyphicon glyphicon-menu-up tenup" style="float: right; margin-top: -18px;"></span>
...
<ul id="search-result-items" class="search-result-items tiles-container clearfix show-compare ">
 ...
 foreach ($subcats as $sc) {
    ...
    <?php if(isset($_GET['loft'.$y])) { 
     ...
     $loft_final = $_GET['loft'.$y]; ?>

                <?php if( $term = get_term_by( 'id', $loft_final, 'product_cat' ) ){

                  $search_category= array();
              
                 $search_category[] = $term->name; } ?>
 ...
 foreach ($subcats as $sc) {
    ...
    <?php if(isset($_GET['flex'.$z])) { 
     ...
     $flex_final = $_GET['flex'.$z]; ?>

                <?php if( $term = get_term_by( 'id', $flex_final, 'product_cat' ) ){
   ...
   <?php
    ...
    $search_category[] = $name_sup_subcategory;
    
   //print_r($search_category);
   $final_search = implode(",",$search_category);



  $args = array('post_type' => 'product',  'product_cat' => $final_search , 'posts_per_page' => '100', 'orderby' => 'rand' );
  ...
  //print_r($args);
        ...
        echo ' <div class="alert alert-info">
                ...
                <p style="font-size:16px;">
                    Sorry  No Produt Available in This Category. Please choose other category for Buy the product.</p>
            </div>'; 
