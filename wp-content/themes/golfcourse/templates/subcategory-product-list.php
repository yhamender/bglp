<?php
/*
 * Template Name: SubCategory Product list
*/
?>
...
<link href="//fast.fonts.net/cssapi/a5f58faf-dd1c-4aad-98ce-5b8f3d99e641.css" rel="stylesheet" type="text/css" />
    ...
    ?>
       ...
       <?php } else { ?>
        ...
        <li class="">
          ...
          <a class="refinement-link non-ajax <?php if($subcategory_id==$sc->term_id) { ?> active <?php } else { ?>not-selected <?php } ?>" title="<?php echo $sc->name; ?>" href="<?php echo site_url('supsubcategory-product/?category='.$category_id.'&subcategory='.$subcategory_id.'&supsubcategory='.$sc->term_id);?>"><?php echo $sc->name; ?></a>
...
<?php
    ...
    <?php if($category_id==23 && $sub_category_id ==37 ) { ?>

      <div class="image">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/djbag.jpg" style="width:98%; margin-left: 10px; margin-bottom: 20px; " ></img>
        <h1 style="top:5px; font-size: 50px; font-family: DINNextW01-CondensedBol;">DUSTIN JOHNSON</h1>
        </div>

        <?php } ?>


    <?php if($category_id==23 && $sub_category_id ==38 ) { ?>

      <div class="image">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/jay.png" style="width:98%; margin-left: 10px; margin-bottom: 20px; " ></img>
        <h1 style="top:5px; font-size: 50px; font-family: DINNextW01-CondensedBol;">JASON DAY</h1>
        </div>

        <?php } ?>


    <?php if($category_id==23 && $sub_category_id ==40 ) { ?>

      <div class="image">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/rahmbag.jpg" style="width:98%; margin-left: 10px; margin-bottom: 20px; " ></img>
        <h1 style="top:5px; font-size: 50px; font-family: DINNextW01-CondensedBol;">JON RAHM</h1>
        </div>

        <?php } ?>


    <?php if($category_id==23 && $sub_category_id ==42 ) { ?>

      <div class="image">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/rickiebag.jpg" style="width:98%; margin-left: 10px; margin-bottom: 20px; " ></img>
        <h1 style="top:5px; font-size: 50px; font-family: DINNextW01-CondensedBol;">RICKIE FOWLER</h1>
        </div>

        <?php } ?>


    <?php if($category_id==23 && $sub_category_id ==39 ) { ?>

      <div class="image">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/rorybag.jpg" style="width:98%; margin-left: 10px; margin-bottom: 20px; " ></img>
        <h1 style="top:5px; font-size: 50px; font-family: DINNextW01-CondensedBol;">RORY MCILROY</h1>
        </div>

        <?php } ?>


    <?php if($category_id==23 && $sub_category_id ==43 ) { ?>

      <div class="image">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/sungbag.jpg" style="width:98%; margin-left: 10px; margin-bottom: 20px; " ></img>
        <h1 style="top:5px; font-size: 50px; font-family: DINNextW01-CondensedBol;">SH PARK</h1>
        </div>

        <?php } ?>


      <?php if($category_id==23 && $sub_category_id ==41 ) { ?>

      <div class="image">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/tiger.jpg" style="width:98%; margin-left: 10px; margin-bottom: 20px; " ></img>
        <h1 style="top:5px; font-size: 50px; font-family: DINNextW01-CondensedBol,Arial Narrow,arial,helvetica,sans-serif !important;">TIGER WOODS</h1>
        </div>
