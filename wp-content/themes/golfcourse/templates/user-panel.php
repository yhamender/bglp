...
color: #fff; min-height:270px; text-align: center; width:100%; background-size: cover;">
  <h1 style="margin-top: 147px; color: #fff!important; font-size: 47px; font-family: 'Fjalla One', sans-serif!important;">Welcome To User Dashboard</h1>
</div>
<div class="container">
      ...
      <div class="row">
        <div class="col-md-2 text-center">
          <div class="small-box bg-red">
            ...
            <a href="<?php echo site_url('user-profile'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a> </div>
        </div>
        <div class="col-md-2 text-center">
          <div class="small-box bg-red">
            <div class="inner">
            ...
            <a href="<?php echo site_url('user-profile-edit'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a> </div>
        </div>
        <div class="col-md-2 text-center">
          <div class="small-box bg-red">
            <div class="inner">
            ...
            <a href="<?php echo site_url('download-card'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a> </div>
        </div>
        <div class="col-md-2 text-center">
          <div class="small-box bg-red">
            <div class="inner">
              <h3>1</h3>
              <p>User Booking Order Status</p>
            </div>
            <a href="<?php echo site_url('user-booking-order-status'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a> </div>
        </div>
      </div>
    </div>
  </div>
