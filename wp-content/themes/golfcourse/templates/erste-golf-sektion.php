<?php
/*
 * Template Name: erste-golf-sektion
 * 
 */
?>
...
color: #fff; min-height:270px; text-align: center; width:100%; background-size: cover;">
  <h1 style="margin-top: 147px; color: #fff!important; font-size: 47px; font-family: 'Fjalla One', sans-serif!important;">Erste Golf Sektion</h1>
</div>
<div class="container">
...
<div class="col-md-10 col-md-offset-1" style="padding: 0px 50px 0px 50px;font-size:17px; font:normal normal normal 16px/1.4em proxima-n-w01-reg,sans-serif; color:#414141; line-height:1.9em; text-align:justify;">
    <h3>
       Als Mitglied der <strong>„ERSTE GOLF SEKTION“</strong> profitieren Sie von 40€ Nachlass auf Ihre <br/>
       <br/>
    ...
    <ul style="list-style-type:square;">
        ...
        <li>Nutzen Sie den Gutscheincode <strong><font color="#FFD700">„ERSTE2020“</font></strong> nach der Registrierung.</li>
